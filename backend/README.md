...
## Project Structure
    ...
    ├── theinnercircle_34479  # Django project configurations
...
1. Clone this repo and `cd theinnercircle_34479`
...
2. Clone this repo and `cd theinnercircle_34479`
